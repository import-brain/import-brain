...
| **E1** | [E2](https://github.com/import-brain/import-brain/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+E1+to+E2) |
...
| Total moves |  User  |
| :---------: | :----- |
| 1 | [@import-brain](https://github.com/import-brain) |
